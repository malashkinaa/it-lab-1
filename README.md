...
| Крок                            | Опис дії                                                                                                  |
| ------------------------------- | --------------------------------------------------------------------------------------------------------- |
| **1. Створення БД:**            | Виберіть базу даних зі списку, натисніть "Create Database", введіть назву БД, підтвердіть.                |
| **2. Створення таблиці:**       | Перейдіть на головну сторінку, натисніть "Create Table", введіть назву нової таблиці та підтвердіть.      |
...
| **7. Експорт таблиці в Excel:** | Відкрийте потрібну таблицю, натисніть "Export to Excel", виберіть місце збереження файлу та підтвердіть.  |
...
| -------------------------- | -------------------------- | ------------------------------------ | ------------------------------------ |
| **Використані фреймворки** | Tkinter                    | FastAPI                              | FastAPI                              |
